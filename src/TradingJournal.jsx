                ...
                <tbody>
                  {rows.map((r, i) => {
                    ...
                    <tr key={r.id} style={{ borderTop: isFirstOfDateGroup && i > 0 ? "1px solid var(--border)" : "none", borderBottom: i < rows.length - 1 ? "1px solid var(--border)" : "none" }}>
                      ...
                      {isFirstOfDateGroup && (
                        <td className="tj-mono" rowSpan={dateSpan} style={{ padding: "8px 10px", fontSize: 12, whiteSpace: "nowrap", textAlign: "center", verticalAlign: "middle", borderLeft: dateSpan > 1 ? "2px solid var(--gold-dim)" : "none" }}>{fmtDate(r.date)}</td>
                      )}
