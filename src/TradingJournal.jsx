        ...
        <div className="flex items-center gap-2" style={{ marginBottom: 16 }}>
          ...
          <button
            ...
            style={{
              ...
              fontSize: 12.5,
              fontWeight: 600,
              border: `1px solid ${activeView === "fundamental" ? "var(--gold-dim)" : "var(--border)"}`,
              background: activeView === "fundamental" ? "rgba(198,161,91,0.1)" : "var(--surface)",
              color: activeView === "fundamental" ? "var(--gold)" : "var(--muted)",
              cursor: "pointer",
            }}
          >
            <CalendarClock size={14} /> Fundamental
          </button>
        </div>

        {activeView === "chart" && <TradingViewChart theme={theme} />}
        {activeView === "fundamental" && <EconomicCalendar theme={theme} />}
