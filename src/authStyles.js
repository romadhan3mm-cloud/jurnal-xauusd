...
.auth-close-btn { position: fixed; top: max(16px, env(safe-area-inset-top)); right: 16px; z-index: 50; width: 34px; height: 34px; display: flex; align-items: center; justify-content: center; background: #12161C; border: 1px solid #232A34; border-radius: 8px; color: #7C828C; cursor: pointer; }
...
.auth-brandmark { display: block; margin: 0 auto 10px; }
